...
1. **인벤토리** — 저장소별 소유 부서, 문서 수, 등급 분포, 접근 주체 체계, 문서보안 적용 여부를 실측합니다. 세기 전에 결정하지 않는다는 전사 방법론의 원칙([AX 01 1.4절](https://github.com/JaeHoYun/enterprise-ax-methodology/blob/main/docs/01-starting-point.md))을 데이터에 적용한 단계입니다.
